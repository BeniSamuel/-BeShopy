...
const Footer = () => {
  return (
    <div className=' py-14 bg-[#224F34] flex flex-col gap-16'>
        <div className=' flex flex-col md:flex-row md:gap-40 md:justify-center '>
            ...
            <div className=' flex flex-col gap-3'>
                ...
                <div className=' flex flex-row items-center'>
                    <input type="email" placeholder='Enter Your Email' className=' bg-transparent placeholder:font-poppins placeholder:text-white border-2 border-[#A3F3BE] py-2 pl-4 outline-none text-white'/>
        ...
        <div className=' flex flex-row items-center gap-4 justify-center'>
            <div className=' bg-[#A3F3BE] h-[0.12rem] w-[52rem]'></div>
