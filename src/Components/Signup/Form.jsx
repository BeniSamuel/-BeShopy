      ...
      <div className=" flex flex-col items-center w-1/2 gap-9">
        ...
        <div className=" flex flex-col gap-6">
          <input
            type="text"
            placeholder="Name"
            className=" outline-none border-b-2 border-[#224F34] bg-transparent w-96 placeholder:font-poppins font-poppins"
          />
          <input
            type="text"
            placeholder="Email"
        ...
        <div className=" flex flex-col gap-3">
          <button className=" bg-[#224F34] text-white font-poppins w-96 py-3">
            Signup
          </button>
